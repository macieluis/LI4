...
O Gerente de Loja gere a operação diária da sua loja. Tem acesso a todas as funcionalidades operacionais da sua loja, bem como à gestão dos Funcionários da sua própria loja. Não tem acesso a dados de outras lojas nem a funcionalidades de administração central.

**Acesso permitido:** Dashboard da sua loja, POS da sua loja, Gestão de Stock da sua loja, Encomendas da sua loja, Faturas da sua loja, Relatórios da sua loja, Gestão de Funcionários da sua loja (criar, editar, desactivar — papel Funcionário apenas).  
**Acesso negado:** Dados de outras lojas, criação de Gerentes ou Gestores, Consolidação global.
...
| Consolidação Diária | ❌ | ❌ | ✅ |
| Admin – Utilizadores | ❌ | ✅ (só Funcionários da sua loja) | ✅ (todos os utilizadores) |
